...
struct node* deletenodepos(struct node* head, int position, int size){
...
int main(){
    ...
    int n, position;
    printf("Do you want to delete an element from the linked list? 1/0 ");
    scanf("%d", &n);

    if(n==1){
        printf("Enter the position of the element : ");
        scanf("%d", &position);
        head = deletenodepos(head, position, size);
        print(head);
    }
